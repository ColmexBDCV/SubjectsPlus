...
$subsubcat = "";
$subcat = "admin";
$page_title = "Departamentos de administración";
$feedback = "";
...
if (isset($_POST["add_department"])) {
    ...
    if ($rInsertDept) {
        $feedback = _("Hágase Tu Voluntad. Lista de departamento actualizada.");
...
if (isset($_POST["update_departments"])) {
    ...
    $feedback = _("Hágase Tu Voluntad. Orden de lista de departamento actualizado.");
    // Show feedback
...
foreach ($deptArray as $value) {
    ...
    $ourlist .= "<li id=\"item-$value[0]\" class=\"sortable_item department-sortable\"><a id=\"delete-$value[0]\"><i class=\"fa fa-times\" title=\"" . _("Remover") . "\"></i></a>
...
<button id=\"save_guide\" class=\"button pure-button pure-button-primary\" style=\"display: block;\" name=\"update_departments\" >" . _("Guardar Cambios") . "</button>
...
<label for=\"department\">" . _("Nombre del Departamento") . "</label>
<input type=\"text\" name=\"department\" id=\"\" size=\"40\" value=\"\">

<label for=\"telephone\">" . _("Télefono ") . "</label>
...
<p></p>
<button class=\"button pure-button pure-button-primary\" id=\"add_dept\" name=\"add_department\" >" . _("Agregar Nuevo Departamento") . "</button>
</form>";

$view_depts_box = "<ul>
<li><a href=\"$PublicPath" . "/staff.php?letter=By Department\" target=\"_blank\">" . _("Personal por Departamento") . "</a></li>
</ul>";
...
";
  ...
  makePluslet(_("Departamentos"), $dept_box, "no_overflow");

print "</div>
<div class=\"pure-u-1-3\">";

makePluslet(_("Agregar Departamento"), $add_dept_box, "no_overflow");

makePluslet(_("Ver en directo!"), $view_depts_box, "no_overflow");
